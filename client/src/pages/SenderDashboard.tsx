              ...
              <div className="bg-white rounded-xl p-12 sm:p-16 text-center shadow-sm" data-testid="section-track-coming-soon">
                <div className="max-w-md mx-auto">
                  ...
                  <p className="text-sm sm:text-base text-gray-500 leading-relaxed">
                    Track your parcels in real-time with live location updates, delivery status notifications, and estimated arrival times. Stay connected with your traveler throughout the entire delivery journey.
                  </p>
